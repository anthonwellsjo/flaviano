...
import classes from './ProductPageTemplateMobileRender.module.scss';
...
const ProductPageTemplateMobileRender = ({ data }: ProductPageDataQuery) => {
    ...
    <LayoutMobile>
      <Parallax pages={2.4} scrolling={true} ref={parallax}>
        ...
        <div style={{ width: "100%", height: "100vh", position: "relative" }}>
          ...
          <ParallaxLayer factor={0} speed={-0.5}>
            <Centralizer column>
              <div style={{ position: "absolute", width: "7em", marginTop: "25vh", textAlign: "center" }}>
                <Quote rightQuoteX={"15px"} style={QuoteStyle.header}>{data.sanityProduct.category.title.split("").splice(0, 1).join()}</Quote>
              </div>
              <div style={{ position: "absolute", top: "35vh", width: "80%", textAlign: "center" }}>
...
export default ProductPageTemplateMobileRender;