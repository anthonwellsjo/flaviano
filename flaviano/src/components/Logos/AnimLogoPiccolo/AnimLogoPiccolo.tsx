...
const AnimLogoPiccolo: React.FC = () => {
  ...
  const FlowerProps = useSpring({
    to: { transform: hover ? "scale(3)" : "scale(2)" },
  ...
  return (
    <div style={{ width: "100vw", display: "flex", alignItems: "center", justifyContent: "center", position: "fixed" }}>
      <div style={{ width: "100vw", maxWidth: "1300px", position: "fixed" }}>
        <Link to="/">
...
export default AnimLogoPiccolo;