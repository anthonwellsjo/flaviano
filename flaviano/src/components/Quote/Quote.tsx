...
const Quote = ({ children, style }: QuoteProps) => {
  ...
  return (
    <div className={classes.body}>
      <div style={{transform: style == QuoteStyle.header ? "scale(1.5)" : null}} className={classes.leftQuote}>
      ...
      <div style={{transform: style == QuoteStyle.header? "translateY(70px) scale(1.5)" : null}} className={classes.rightQuote}>
        <svg width="30" height="25" viewBox="0 0 30 25" fill="none" xmlns="http://www.w3.org/2000/svg">
