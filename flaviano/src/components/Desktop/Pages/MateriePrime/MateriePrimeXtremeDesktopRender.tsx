...
const MateriePrimeXtremeDesktopRender: React.FC = () => {
      ...
      <LayoutFrameDesktop>
        ...
        <ParallaxLayer offset={1} speed={0.5}>
          <div style={{ height: "500px", }}>
            <Centralizer>
              <div style={{ maxWidth: "389px", height: "500px", width: "30%", position: "absolute", right: "10%", top: "25vh" }}>
              ...
              <div style={{ width: "45%", wordSpacing: ".3em", position: "absolute", top: "350px", left: "10%" }}>
        ...
        <ParallaxLayer offset={1.99} speed={1}>
          <div style={{ height: "500px", backgroundColor: "white", position: "relative" }}>
            <Centralizer>
              <div style={{ width: "15%", height: "500px", backgroundColor: sanityMateriePrimePage.melaColor.hex, position: "absolute", left: 0, top: "0" }}></div>
...
export default MateriePrimeXtremeDesktopRender;